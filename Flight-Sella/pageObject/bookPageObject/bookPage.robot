...
Input Start Date 01 October 2019
    Wait Until Element Is Visible    ${satu-oktober}
    Click Element    ${satu-oktober}
Click OK on Date
...
Input End Date 05 October 2019
    Wait Until Element Is Visible    ${lima-oktober}
    Click Element    ${lima-oktober}
